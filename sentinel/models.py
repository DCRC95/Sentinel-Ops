...
class Contractor(Base):
    ...
    contractor_id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
...
class Submission(Base):
    ...
    contractor_id: Mapped[str] = mapped_column(ForeignKey("contractors.contractor_id"), nullable=False)
